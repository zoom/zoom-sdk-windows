...
public:
	...
	virtual void onWindowMsgNotification(UINT uMsg, WPARAM wParam, LPARAM lParam) {onVideoContainerWindowMsgNotification(uMsg, wParam, lParam);} //need to be modified later -- wilmer
