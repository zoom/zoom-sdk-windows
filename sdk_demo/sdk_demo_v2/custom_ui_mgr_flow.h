...
//	virtual void onRecording2MP4Processing(int iPercentage) = 0;
	...
	//-------wilmer: add more interfaces here if you want the customized UI to handle it ---------------//
	/*
	...
	//wilmer for ITestAudioDeviceHelperEvent and ITestVideoDeviceHelperEvent
