...
bool CToolbarMgr::GetMeetingService()
{
...
bool CToolbarMgr::IsInMeeting()
{
	if(GetMeetingService())
	{
		ZOOM_SDK_NAMESPACE::MeetingStatus meetingStatus = m_pMeetingService->GetMeetingStatus();
		if(ZOOM_SDK_NAMESPACE::MEETING_STATUS_IDLE != meetingStatus
			&& ZOOM_SDK_NAMESPACE::MEETING_STATUS_ENDED != meetingStatus
			&& ZOOM_SDK_NAMESPACE::MEETING_STATUS_IN_WAITING_ROOM != meetingStatus)
			return true;
	}
	return false;
}
