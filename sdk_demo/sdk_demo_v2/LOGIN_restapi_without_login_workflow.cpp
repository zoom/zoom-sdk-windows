...
bool CSDKRestAPIUserWorkFlow::GetMeetingService()
{
...
bool CSDKRestAPIUserWorkFlow::IsInMeeting(ZOOM_SDK_NAMESPACE::MeetingStatus status)
{
...
bool CSDKRestAPIUserWorkFlow::RestAPIStartMeeting(ZOOM_SDK_NAMESPACE::StartParam& startParam)
{
