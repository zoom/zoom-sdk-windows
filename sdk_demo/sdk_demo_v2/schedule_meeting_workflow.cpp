...
bool CSDKSheduleMeetingUIWorkFlow::ScheduleMeeting()
{
	if (m_pPreMeetingService)
	{
...
bool CSDKSheduleMeetingUIWorkFlow::DeleteMeeting(UINT64 meetingUniqueID)
{
	if (m_pPreMeetingService)
	{
		ZOOM_SDK_NAMESPACE::SDKError err;
...
bool CSDKSheduleMeetingUIWorkFlow::ListMeeting()
{
	if (m_pPreMeetingService)
	{
		ZOOM_SDK_NAMESPACE::SDKError err;
...
bool CSDKSheduleMeetingUIWorkFlow::EditMeeting()
{
