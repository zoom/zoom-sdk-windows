...
bool CSDKWithoutLoginStartJoinMeetingFlow::JoinMeeting(ZOOM_SDK_NAMESPACE::JoinParam& paramJoinMeeting)
{
	...
	if(m_pAuthService)
	{
		if(IsMeetingServiceReady())
		{
			...
			ZOOM_SDK_NAMESPACE::SDKError err = m_pMeetingService->Join(paramJoinMeeting);
